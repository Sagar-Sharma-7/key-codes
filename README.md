...
## Built with 
 ...
 1. Type `git clone https://github.com/Sagar-Sharma-7/flip-text.git`
...
## Contributions
### Contributions are welcome! see [Contribution's Guide](https://github.com/Sagar-Sharma-7/flip-text/blob/main/CONTRIBUTING.md)
...
### Be nice. See our [code of conduct](https://github.com/Sagar-Sharma-7/flip-text/blob/main/CODE_OF_CONDUCT.md)
